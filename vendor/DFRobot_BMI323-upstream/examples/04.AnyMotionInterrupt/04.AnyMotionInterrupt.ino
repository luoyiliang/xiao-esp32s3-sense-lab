/*!
 * @file 04.AnyMotionInterrupt.ino
 * @brief Demonstrates BMI323 any-motion (slope) interrupt on INT1/INT2.
 * @details Connect INT1/INT2 of BMI323 to the MCU pin defined by intPin. Whenever the
 * @n sensor detects motion exceeding the configured threshold for the specified
 * @n duration, an interrupt will fire and the sketch will log the event.
